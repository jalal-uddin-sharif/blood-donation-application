...
const Footer = () => {
    ...
    return (
        <footer className="text-gray-500 bg-gray-100 px-4 py-5 w-full">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                <h1 className='text-lg text-red-600 font-medium'>Red <span className='text-green-500'>Love</span> </h1>
                <p className="leading-relaxed mt-2 text-[15px]">
                we believe in the power of blood donation to save lives. Join us in our mission to make a difference in the lives of those in need. Whether you're a donor, a volunteer, or someone seeking blood, together we can make a positive impact.
                </p>
            </div>
            ...
            <div className="mt-8 items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2024 Red Love All rights reserved.
                </div>
