...
const Footer = () => {
    ...
    return (
        <footer className="mt-14 border-t border-pink-100 bg-white/90 px-4 py-8 text-slate-600">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                <div className="flex justify-center">
                    <TextLogo />
                </div>
                <p className="leading-relaxed mt-2 text-[15px]">
                We believe in the power of blood donation to save lives. Join us in our mission to make a difference in the lives of those in need.
                </p>
            </div>
            <ul className="items-center justify-center mt-8 space-y-5 sm:flex sm:space-x-4 sm:space-y-0">
                {
                    footerNavs.map((item, idx) => (
                        <li key={idx} className="font-medium hover:text-pink-600">
                            <a href={item.href}>
                                { item.name }
                            </a>
                        </li>
            ...
            <div className="mt-8 items-center justify-between sm:flex">
                ...
                <div className="mt-6 sm:mt-0">
                    <ul className="flex items-center space-x-4">
                        <li className="flex h-10 w-10 items-center justify-center rounded-full border border-pink-100 bg-pink-50">
